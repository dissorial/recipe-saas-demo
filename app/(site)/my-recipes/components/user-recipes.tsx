...
interface UserRecipeCardProps extends React.HTMLAttributes<HTMLDivElement> {
  recipe: Recipe
...
export async function UserRecipeCard({
  recipe,
              ...
              <ScrollArea className="h-[400px]">
                <div className="">
                  {recipe?.ingredients?.map((ingredient, index) => {
                    return (
                      <div className="flex items-center border-b py-2 pr-4">
